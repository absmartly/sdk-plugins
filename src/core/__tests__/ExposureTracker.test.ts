  ...
  describe('registerExperiment', () => {
    it('should trigger exposure immediately for changes without trigger_on_view', async () => {
      ...
      tracker.registerExperiment(
        ...
        changes,
        allVariantChanges,
        flags.hasImmediateTrigger,
        flags.hasViewportTrigger
      );
  ...
  describe('multiple experiments', () => {
    it('should track multiple experiments independently', async () => {
      ...
      tracker.registerExperiment(
        ...
        exp1Changes,
        [exp1Changes],
        flags1.hasImmediateTrigger,
        flags1.hasViewportTrigger
      );
      ...
      tracker.registerExperiment(
        ...
        exp2Changes,
        [exp2Changes],
        flags2.hasImmediateTrigger,
        flags2.hasViewportTrigger
      );
